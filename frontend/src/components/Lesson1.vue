...
<script>
  ...
  export default {
    ...
    mounted() {
      axios({method: 'GET', url: 'https://192.168.6.2/xxe/lesson1/people'})
        .then(result => {
    ...
    methods:
      {
        ...
        addPersion() {
          ...
          axios({ method: "POST", "url": "https://192.168.6.2/xxe/lesson1/create", "data": formData, "headers": { "content-type": "multipart/form-data" } }).then(result => {
          }, error => {
            console.error(error);
